...
- Phase 22 now limits Marangoni stress to the liquidus–boiling interval and recoil/surface recession to temperatures above boiling, based on Alphonso et al. 2023, DOI `10.1016/j.jmapro.2023.03.040`. Two focused CPU Warp tests pass; the full Phase 22 CPU Warp suite passes **21/21**. CUDA execution of this Warp solver remains unverified, and recoil's coupling to both interface recession and momentum impulse remains unresolved.
...
- A fixed-frame rectangular bare-plate corridor implementation is underway for P5. Resource limits, 4.9/6.0 mm observation positions, and NIST acceptance gates remain unchanged until its focused verification is complete.
