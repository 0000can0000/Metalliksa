...
- Goal **aktif**. P4 ağ geometrisi yakınsamadı; P5 gerçek NIST optik hata hesabı için 10 mm deney koşulu, ölçülmüş ışın profili, uygun kesit operatörü ve bağımsız 3+3 yakınsama eksik. Sıradaki adım: P4 başarısızlığının nedenini dondurulmuş eşiği değiştirmeden daraltmak; resmî kaynak satırlarını kullanacak eşleşmiş optik operatörü ve gerçek 10 mm çözümü ayrı doğrulamak. Dış `docs/README.md`, `sonkayıtlar/LOG.md` ve `docs/SCIENTIFIC_RESEARCH_VISION.md` değişiklikleri korunuyor. Push/yayın yapılmadı.
