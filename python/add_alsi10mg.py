...
def generate_alsi10mg_data():
    ...
    data = []
    print("Generating AlSi10Mg physical dataset...")
    ...
    print(f"Added {len(df_new)} rows for AlSi10Mg. Total dataset size: {len(df_combined)}")

if __name__ == "__main__":
    generate_alsi10mg_data()
    print("Training surrogate for AlSi10Mg...")
    train_surrogate("AlSi10Mg", 200)
    print("Done!")
