...
export default function App() {
  ...
  function renderModule(id: ModuleId) {
    switch (id) {
      ...
      case 'electrochem-suite': return <ElectrochemicalAnalysisSuite />;
      case 'aerospace-pdf-audit': return <AerospaceAuditReportGenerator />;
      case 'hardness-tensile': return <HardnessToTensileLab onNavigate={navigate} />;
      case 'mechanical-ai-lab': return <MechanicalPropertyAILab />;
      case 'ttt-cct-kinetics': return <PhaseKineticsTTTCCTStudio onSendToModule={navigate} />;
      case 'ebsd-lab': return <AIEbsdGrainLab />;
      case 'xrd-lab': return <RapidXRDAnalysisLab onNavigate={navigate} />;
      case 'hypersonic-tps': return <HypersonicAblationLab />;
      case 'icme-motor': return <ICMEModule />;
      case 'thermal-scheduler': return <ThermalCycleScheduler onNavigate={navigate} />;
