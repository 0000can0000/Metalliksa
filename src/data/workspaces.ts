...
export const MODULES = [
  ...
  { id: 'murakami-fatigue', workspace: 'lpbf', label: 'Fatigue & Fracture Lab', scope: 'Research', description: 'Phase 13: Kitagawa-Takahashi diagrams, El-Haddad small defect limits and Paris crack propagation.', next: 'research-hub' },
