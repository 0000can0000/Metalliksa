...
export const MODULES = [
  ...
  { id: 'modulus-fno-lab', workspace: 'lpbf', label: 'Modulus FNO Surrogate', scope: 'Preview', description: 'Phase 11: Part-scale 3D thermal history prediction using NVIDIA Modulus Fourier Neural Operators.', next: 'research-hub' },
