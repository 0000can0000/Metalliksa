...
export const MODULES = [
  ...
  { id: 'toolpath-thermal-map', workspace: 'lpbf', label: 'Toolpath Thermal Map', scope: 'Preview', description: 'Phase 12+17: Lazer tarama stratejisine göre (Chessboard/Stripe) 2D takım yolu ve çoklu-hat termal ısı birikimi görselleştirme.', next: 'industrial-certification' },
