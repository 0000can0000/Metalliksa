...
export const MODULES = [
  ...
  { id: 'adaptive-mitigation', workspace: 'lpbf', label: 'Defect Mitigation', scope: 'Research', description: 'Phase 15: Inverse kinematic power compensation and 67° scan rotation for defect suppression.', next: 'research-hub' },
