...
export const MODULES = [
  ...
  { id: 'defect-twin', workspace: 'lpbf', label: 'Spatial Defect Twin', scope: 'Research', description: 'Phase 14: CAD/STL 3D voxelization, spatial defect mapping and relative density (%99.X).', next: 'research-hub' },
