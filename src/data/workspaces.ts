...
export const MODULES = [
  ...
  { id: 'thermomechanical-distortion', workspace: 'lpbf', label: 'Thermomechanical Lab', scope: 'Research', description: 'Macro-scale inherent strain estimation and King & Cunningham keyhole porosity risk analysis.', next: 'research-hub' },
