...
export const MODULES = [
  ...
  { id: 'experimental-validation', workspace: 'lpbf', label: 'EBSD/CT Validation', scope: 'Research', description: 'Phase 10: Experimental EBSD/CT metric comparison and Traceability Pipeline.', next: 'research-hub' },
