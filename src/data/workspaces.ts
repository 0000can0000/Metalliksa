...
export const MODULES = [
  ...
  { id: 'toolpath-studio', workspace: 'lpbf', label: 'Toolpath & Kinematics', scope: 'Research', description: 'Phase 12: Galvanometer mirror acceleration, G-Code/CLI delays and local thermal hotspot detection.', next: 'industrial-certification' },
