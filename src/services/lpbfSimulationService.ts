...
export interface SimulationInput {
  ...
  strategy?: "meander" | "unidirectional"; scanAngle_deg?: number; layerRotation_deg?: number;
  ...
  absorptivity?: number; study?: "none" | "mesh" | "timestep";
  properties?: unknown;
  measurements?: { width_um: number; depth_um: number; source: string }[];
}
...
export interface SimulationJob {
  ...
  progress: number; log: string; error: string | null; cacheHit?: boolean; result?: SimulationResult;
}
