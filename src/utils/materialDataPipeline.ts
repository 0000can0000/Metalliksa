    ...
    stages = [
      {
        ...
        type: "ramp",
        startTemp_C: 25,
        targetTemp_C: Math.min(solidusTemp - 50, solvusTemp + 15),
        rate_C_per_min: 15,
        duration_min: Math.round((solvusTemp - 10) / 15),
        atmosphere: "Vacuum",
      ...
      },
      {
        ...
        type: "soak",
        startTemp_C: Math.min(solidusTemp - 50, solvusTemp + 15),
        targetTemp_C: Math.min(solidusTemp - 50, solvusTemp + 15),
        duration_min: 60,
        atmosphere: "Vacuum",
    ...
    stages = [
      {
        ...
        type: "ramp",
        startTemp_C: 25,
        targetTemp_C: solvusTemp - 40,
        rate_C_per_min: 12,
        duration_min: Math.round((solvusTemp - 65) / 12),
        atmosphere: "Vacuum",
    ...
    stages = [
      {
        ...
        type: "ramp",
        startTemp_C: 25,
        targetTemp_C: Math.min(solidusTemp - 15, solvusTemp),
        rate_C_per_min: 10,
        duration_min: 48,
        atmosphere: "Air",
      ...
      },
      {
        ...
        name: "Solution Soak",
        type: "soak",
        startTemp_C: Math.min(solidusTemp - 15, solvusTemp),
        targetTemp_C: Math.min(solidusTemp - 15, solvusTemp),
        duration_min: 60,
        atmosphere: "Air",
    ...
    stages = [
      {
        ...
        type: "ramp",
        startTemp_C: 25,
        targetTemp_C: ac3Temp + 45,
        rate_C_per_min: 15,
        duration_min: Math.round((ac3Temp + 20) / 15),
        atmosphere: "Nitrogen",
